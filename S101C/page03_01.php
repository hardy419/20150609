...
<div class='left_content'>
			...
			<img src="images/page/5.jpg" width="850" border="0" usemap="#Map" title="但若題目改為﹕例二﹕如果我有3元，要支付5元，還剩多少?"/>
			<map name="Map" id="Map">
				<area shape="rect" coords="66.424619640387,389.14246196404,82.883817427386,405.60165975104" href="./page03_02.php">
			</map>
			</div>
		</div><!--left_content-->
