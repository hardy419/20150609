...
<div class='left_content'>
			...
			<img src="images/page/89.jpg" width="850" border="0" usemap="#Map" title="從小學我們學過﹕被乘數 × 乘數 = 積 同時可得到﹕乘數=積÷被乘數及被乘數 =積÷乘數 利用前面所得的結果﹕"/>
			<map name="Map" id="Map">
				<area shape="rect" coords="620.15905947441,175.76071922545,636.61825726141,192.21991701245" href="./page41_03.php">
			</map>
			</div>
		</div><!--left_content-->
